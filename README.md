...
The door drawing system has been improved (new scripts in scripts/doorDraw). It is now much easier to add new mechanics that need alterations to the door drawing system.<br>
The mouseover system has been improved (new scripts in scripts/mouseover). It is now much easier to add new mechanics that need alterations to the mouseover system.
