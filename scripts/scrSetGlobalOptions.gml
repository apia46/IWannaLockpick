...
global.ultraSave = false;       //If active, the next save you create unlocks every level
...
global.roomCaptionDef = "I Wanna Lockpick";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rMainHub;    //sets which room to begin with

global.colorAssist = 0;         //Colorblind symbols appear over keys and doors.
global.colorBlind = 0;          //Second attempt at color accessibility
...
global.usingController = false;     //changes depending on the previous input
