...
var _spr = sprDoorBig;
var dIndex = 0;
if argument0{//Outer lock sprites
    if !_isNegative{dIndex = 6;}else{dIndex = 7;}//+ and +i are positive, - and -i are negative
}else{//Inner lock sprites
    _spr = sprDoorBigInner;
    if !_isNegative{dIndex = 0;}else{dIndex = 1;}//+ and +i are positive, - and -i are negative
}
